...
// document.writeln(document.getElementById("header1"));

// document.writeln(document.getElementById("header1").innerText);
...
// let a = document.getElementsByClassName("li1");
// for(let  i = 0; i<a.length; i++)
//     a[i].innerHTML = "List Item: " + (i+1); 
